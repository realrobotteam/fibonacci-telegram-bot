...
from handlers import (
    start, gemini_private_handler, gemini_private_handler_photo, gemini_private_handler_document,
    gemini_private_handler_voice, gemini_private_handler_video, gemini_private_handler_audio,
    gemini_private_handler_video_note, gemini_private_handler_sticker, gemini_private_handler_animation,
    gemini_private_handler_location, gemini_private_handler_contact, gemini_private_handler_poll,
    gemini_private_handler_dice, gemini_private_handler_venue, gemini_private_handler_invoice,
    gemini_private_handler_successful_payment, gemini_private_handler_connected_website,
    gemini_private_handler_passport_data, gemini_private_handler_proximity_alert_triggered,
    gemini_private_handler_web_app_data, gemini_private_handler_message_auto_delete_timer_changed,
    gemini_private_handler_voice_chat_scheduled, gemini_private_handler_voice_chat_started,
    gemini_private_handler_voice_chat_ended, gemini_private_handler_voice_chat_participants_invited,
...
def register_handlers(bot: AsyncTeleBot):
    """ثبت هندلرهای ربات فقط برای چت خصوصی"""
    # دستورات اصلی
    bot.register_message_handler(start, commands=['start'], pass_bot=True)
    bot.register_message_handler(admin_command, commands=['admin'], pass_bot=True)
